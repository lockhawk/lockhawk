...
export const DATA_MARKER = '<!--NPM_SCANNER_DATA-->';
...
<title>npm-scanner report — ${esc(result.target.root.name)}</title>
${dataScript}
<style>
...
<footer>Generated by npm-scanner v${esc(result.tool.version)} · data from OSV.dev · database: ${esc(
